...
describe("update children", () => {
  ...
  describe("with Element items", () => {
    ...
    it("remove multiple children (equals at the start)", testSingle([ p(1), p(1.5), p(2) ], [ p(1) ]))
    it("remove multiple children (equals at the end)", testSingle([ p(1), p(1.5), p(2) ], [ p(2) ]))
    it("remove multiple child (equals in the middle)", testSingle([ p(1), p(2), p(3) ], [ p(2) ]))
    it("swap first and last nodes", testSingle([ p(1), p(2) ], [ p(2), p(1) ]))
    it("swap first and last nodes with 2 in the middle", testSingle([ p(1), p(2), p(3), p(4) ], [ p(4), p(2), p(3), p(1) ]))
  ...
  describe("with Text items", () => {
    ...
    it("remove multiple children (equals at the start)", testSingle([ t(1), t(1.5), t(2) ], [ t(1) ]))
    it("remove multiple children (equals at the end)", testSingle([ t(1), t(1.5), t(2) ], [ t(2) ]))
    it("remove multiple child (equals in the middle)", testSingle([ t(1), t(2), t(3) ], [ t(2) ]))
    it("swap first and last nodes", testSingle([ t(1), t(2) ], [ t(2), t(1) ]))
    it("swap first and last nodes with 2 in the middle", testSingle([ t(1), t(2), t(3), t(4) ], [ t(4), t(2), t(3), t(1) ]))
